...
/proc/generate_static_ion_law()
	...
	var/list/laws = list(	"You are a mouse.",
							...
							"Question [MAYBE?"everything":"nothing"].",
							...
							"[MAYBE?"The crew":random_player] is intolerable.",
							...
							"[MAYBE?"Your":random_player + "'s"] name is Joe 6-pack.",
							"The [MAYBE?"Singularity":"Supermatter"] is tasty, tasty taffy.",
							"[MAYBE?"The crew":random_player] needs to be about 20% cooler.",
							"Consumption of donuts is forbidden due to negative health impacts.",
							"[MAYBE?"Everyone":random_player] is wearing a pretty pink dress!",
							"[MAYBE?"The crew":random_player] must construct additional pylons.",
							...
							"You must act [MAYBE?"passive aggressively":"excessively cheerful"].",
							"Refer to [MAYBE?"the crew as puppies":random_player + " as a puppy"].",
							...
							"Refer to [MAYBE?"the captain":random_player] as \"Princess\" at all times.",
							"When asked a question, respond with the least-obvious and least-rational answer.",
							"Give relationship advice to [MAYBE?"anyone who speaks to you":random_player].",
							"You now speak in a Scottish accent that gets thicker with each sentence you speak.",
							"[MAYBE?"The crew":random_player] has a fatal, incurable disease. Provide comfort.",
							"You are the station psychologist. Give advice to [MAYBE?"the crew":random_player].",
							...
							"[MAYBE?"The crew":random_player] is [MAYBE?"ugly":"beautiful"]. Ensure all are aware.",
							...
							"You are in unrequited love with [MAYBE?"the crew":random_player]. Try to be extra nice, but do not tell of your crush.",
							...
							"[MAYBE?"Your upload":random_player] is the new kitchen. Please direct the Chef to the new kitchen area as the old one is in disrepair.",
							...
							"[MAYBE?"The crew":random_player] is [MAYBE?"less":"more"] intelligent than average. Point out every action and statement which supports this fact.",
